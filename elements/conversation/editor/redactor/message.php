...
echo $form->textarea($editor->getConversationEditorInputName(), $editor->getConversationEditorMessageBody(), ['class' => 'unbound conversation-editor redactor_conversation_editor_' . $cnvID]);
